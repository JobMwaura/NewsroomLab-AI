...
export const demoCourses = [
  {
    ...
    description:
      "Foundational course in newspaper journalism. Students learn to produce hard news, features, and investigative stories while mastering verification discipline and ethical reporting.",
  ...
  {
    id: "course-2",
    title: "Digital Journalism & Online Reporting",
    code: "HCC 318",
    institution: "University of Nairobi",
    semester: "Semester 1 2026",
    description:
      "Advanced course covering online news production, multimedia storytelling, and social media verification.",
    lecturerId: "user-lecturer-1",
    studentCount: 38,
    assignmentCount: 4,
    isArchived: false,
  },
  {
    ...
    description: "Exploration of media law in Kenya, defamation, privacy, and court reporting restrictions.",
    lecturerId: "user-lecturer-1",
    studentCount: 52,
    assignmentCount: 5,
    isArchived: true,
